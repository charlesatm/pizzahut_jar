...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-droaXt7R.mjs");
...
var manifest = {
	"09e48ffa99da9a3a4f80f8173b5b3b51252fac9d5f23ebb704b3a27319123e6b": {
		functionName: "listCodes_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"0b9a8a436da80f351c40001270d0ad2a3128a7065f1201f1abad6211a7a1040b": {
		functionName: "markInvalid_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"38f36c68bcad0e851ed493418c07fead12c3b31deff5206585612a50c50c9792": {
		functionName: "getStats_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"919801227d241262dfceb76726169d628e4cd51fb83fc80ccfd1cd29c28ea59f": {
		functionName: "markUsed_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"9401020b9e6d7d6ce5f59ebd784670dc038a75403bf43c3e954047b60c5bb0d2": {
		functionName: "thankCode_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"ae695431145f432348b82c42eb44012b597e9934a10318661013082e995c7f8d": {
		functionName: "createCode_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	},
	"eeca44e263b368c3d00ff381a2a621f80d6b0261eb7fe3703e3241e91e9425a3": {
		functionName: "grabCode_createServerFn_handler",
		importer: () => import("./codes-DQyUlCrE.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cp92vq_-.mjs").then((n) => n.t),
